  ...
  Widget build(BuildContext context) {
    return stateRequest == StateRequest.loading
        ...
        : stateRequest == StateRequest.serverException
            ? Center(
                child: Lottie.asset('assets/lottie/internal-server-error.json',width: 250, height: 250,repeat: true))
            : stateRequest == StateRequest.serverFaluire
                ?  Center(
                    child: Lottie.asset('assets/lottie/failure.json',width: 250, height: 250,repeat: true))
                : stateRequest == StateRequest.failure
                    ?  Center(
                        child: Lottie.asset('assets/lottie/errorfailure.json',width: 250, height: 250,repeat: true)) 
